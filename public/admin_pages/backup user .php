...
.table-container {
    overflow-x: auto !important;      /* force it */
    max-width: 100%;                  /* very important */
}

.table-container table {
    width: 100%;
    min-width: 1000px;                /* ← adjust this: 900–1300px depending on your needs */
    table-layout: fixed;              /* ← this is the key line! */
}

/* Force columns to respect their container + show ellipsis on long text */
.table-container th,
.table-container td {
    overflow: hidden;
...
/* Optional: give more space to the widest columns (client table especially) */
.client-table th:nth-child(4),   /* Company name */
.client-table td:nth-child(4),
.client-table th:nth-child(5),   /* Business Type */
.client-table td:nth-child(5) {
    width: 20%;                      /* or 220px – 300px */
    max-width: 300px;
}
                        ...
                        <tbody>
                            <?php foreach ($clientUsers as $user): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($user['business_type'] ?? 'N/A') ?></td>
                                    <td><?= htmlspecialchars($user['username']) ?></td>
                                    <td>
